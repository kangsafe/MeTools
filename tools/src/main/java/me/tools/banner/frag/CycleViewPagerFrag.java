...
import me.tools.R;
import me.tools.banner.ViewPagerBase;
import me.tools.banner.ViewPagerHandler;
 ...
 */
@SuppressLint("NewApi")
public class CycleViewPagerFrag extends Fragment implements OnPageChangeListener {
	
	private List<ImageView> imageViews = new ArrayList<ImageView>();
	private ImageView[] indicators;
	private FrameLayout viewPagerFragmentLayout;
	private LinearLayout indicatorLayout; // 指示器
	private ViewPagerBase viewPager;
	private ViewPagerBase parentViewPager;
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		viewPager = (ViewPagerBase) view.findViewById(R.id.viewPager);
		...
		handler = new ViewPagerHandler(getActivity()) {
	 ...
	 * @return viewPager
	 */
	public ViewPagerBase getViewPager() {
		return viewPager;
	}
	 ...
	 */
	public void disableParentViewPagerTouchEvent(ViewPagerBase parentViewPager) {
		if (parentViewPager != null)
